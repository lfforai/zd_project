...
parser.add_argument("-i", "--images", help="HDFS path to MNIST images in parallelized format",default="hdfs://127.0.0.1:9000/mnist_data/train/images")
parser.add_argument("-l", "--labels", help="HDFS path to MNIST labels in parallelized format",default="hdfs://127.0.0.1:9000/mnist_data/train/labels")
