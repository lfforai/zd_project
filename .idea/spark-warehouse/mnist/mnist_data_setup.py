...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output", help="HDFS directory to save examples in parallelized format", default="hdfs://127.0.0.1:9000/mnist_data")
    ...
    if not args.read:
        ...
        writeMNIST(sc, "/lf/tfos/mnist/train-images-idx3-ubyte.gz", "/lf/tfos/mnist/train-labels-idx1-ubyte.gz", args.output + "/train", args.format, args.num_partitions)
        writeMNIST(sc, "/lf/tfos/mnist/t10k-images-idx3-ubyte.gz", "/lf/tfos/mnist/t10k-labels-idx1-ubyte.gz", args.output + "/test", args.format, args.num_partitions)
